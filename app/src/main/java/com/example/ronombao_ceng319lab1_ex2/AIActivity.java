...
public class AIActivity extends Fragment {
    ...
    public AIActivity newInstance(String param1, String param2) {
        AIActivity fragment = new AIActivity();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, param1);
        args.putString(ARG_PARAM2, param2);
        fragment.setArguments(args);
        AIActivity.listView = this.getView().findViewById(R.id.listView);
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_a_i_activity, container, false);
    }
}